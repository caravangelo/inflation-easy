...
This split is intentional: the two cases correspond to different physics inputs (tabulated numerical potential versus analytic potential), so they use different code branches and run-time parameter presets. \vspace{0.5mm} \\ 
